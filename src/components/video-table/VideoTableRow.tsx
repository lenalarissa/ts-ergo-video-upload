...
function useLinkGenerator({createMailLink, showNotice}: LinkGeneratorProps) {
    ...
    return {appLink, createAppLink, mailLink, handleLoadMailLink, qrCodeLink, handleGetQRCodeLink}
}

export default function VideoTableRow({
                                          video, createMailLink, showNotice
                                      }: VideoTableRowProps) {
    const {
        appLink,
        createAppLink,
        ...
        qrCodeLink,
        handleGetQRCodeLink
    } = useLinkGenerator({createMailLink, showNotice})
